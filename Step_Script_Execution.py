...
def restore_screen_image_contents(step_id, space_imageeditors):
    ...
    for (space, space_image_name, zoom) in space_imageeditors:
        ...
        try:
            ...
            if space_image_name in [x.name for x in new_images]:
...
def PW_execute(
    ...
    try:
        ...
        raw_scripts_list = [
            ...
            "stepnum_previously_executed_on": x.step_index_when_previously_executed
            }
        ...
        scripts_list_indexed = [
            ...
            "stepnum_previously_executed_on": x[1]["stepnum_previously_executed_on"]
            }
        ...
        for step_data in scripts_list_indexed:
            ...
            stepnum_previously_executed_on = step_data["stepnum_previously_executed_on"]
            ...
            complete_step_data_array.append({
                "stepnum": stepnum,
                "stepnum_previously_executed_on": stepnum_previously_executed_on,
                "step_id": step_id,
        ...
        for step_data in complete_step_data_array:
            ...
            if should_execute:
                ...
                # If the current step has been reordered to an earlier place, 
                # Also clear the collection that it used to be
                if stepnum_previously_executed_on != stepnum and stepnum_previously_executed_on > stepnum:
                    step_index_to_clear = stepnum_previously_executed_on - 1
                    col_name_to_clear = complete_step_data_array[step_index_to_clear]["col_name"]
                    _ = Scene_Wiping.delete_PW_step_collection(col_name_to_clear, scene, include_children = True, include_col=False)
