...
class PROCESSWRANGLER_OT_executeScriptList(Operator):
    ...
    def invoke(self, context, event):
        ...
        _, steps_execution_override = Helpers.get_steps_execution_override(scn)
    ...
    def execute(self, context):     
        ...
        ui_logging_level = scn.processwrangler_console_log_level
        map_log_level = {
            "DEBUG" : logging.DEBUG,
            "INFO" : logging.INFO,
        ...
        logging_style = scn.processwrangler_console_log_style
        logging_tab_len = scn.processwrangler_console_log_tab
...
class PROCESSWRANGLER_OT_clearAll(Operator):
    ...
    def execute(self, context):
        ...
        for step in scn.processwrangler_step_list:
            step.step_col_name = ""
...
class PROCESSWRANGLER_OT_createPWTemplateScript(Operator):
    ...
    def execute(self, context):
        ...
        context.scene.processwrangler_scripts_in_blend_file = new_text.name
